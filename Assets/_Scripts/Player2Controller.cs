...
public class Player2Controller : MonoBehaviour, IPlayerRevive
{
    public enum State { Idle, Walk, Jump, Attack, JumpAttack, Sleep, Victory, Die }

    [Header("Input System")]
    [SerializeField] private InputActionAsset inputActions;
    [SerializeField] private string actionMapName = "Player2";
    [SerializeField] private string moveActionName = "Player2_Move";
    [SerializeField] private string jumpActionName = "Player2_Jump";
    [SerializeField] private string attackActionName = "Player2_Attack";
    ...
    const string ANIM_IDLE = "2P_Idle";
    const string ANIM_WALK = "2P_Walk";
    const string ANIM_JUMP = "2P_Jump";
    const string ANIM_JUMPATTACK = "2P_JumpAttack";
    const string ANIM_ATTACK = "2P_Attack";
    const string ANIM_DIE = "2P_Die";
    const string ANIM_VICTORY = "2P_Victory";
    const string ANIM_SLEEP = "2P_Sleep";
